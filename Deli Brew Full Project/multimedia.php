    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <div class="w3-center">
            <h2>Multimedia</h2>
            <p>Watch videos and browse through photos here.</p>
          </div>
        </div>
        ...
        <div class="w3-panel">
          <div class="container">
            <div class="grid">
              <div class="cell">
                <div class="w3-center">
                  <img src="#" class="responsive-image" alt="Image Here" name="image" id="image">
                  <div class="w3-panel caption-padding">
                    <div class="caption">
                      Caption here.
                    </div>
                  </div>
          ...
          <div class="container">
            <div class="grid">
              <div class="cell">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/M_I91F-6CeQ" frameborder="0" allowfullscreen></iframe>
              </div>
              <div class="cell">
              </div>
            </div>
