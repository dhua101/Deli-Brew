    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://divascancook.com/wp-content/uploads/2015/12/homemade-cinnamon-rolls-recipe.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Cinnamon Roll</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='13'";
              ...
              ?>
              Quantiity:
              <select id ="quantity13" name="quantity13">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM cinnamonroll_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="cinnamonrollreview.php" method="GET">
                Name<br>
