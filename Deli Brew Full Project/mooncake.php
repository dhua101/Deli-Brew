    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Mooncake.jpg/250px-Mooncake.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Mooncake</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='16'";
              ...
              ?>
              Quantiity:
              <select id ="quantity16" name="quantity16">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM mooncake_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="mooncakereview.php" method="GET">
                Name<br>
