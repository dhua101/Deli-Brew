            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active w3-white"><a href="products.php">Products</a></li>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <h3>What do we have in the Deli Brew?</h3>
        </div>

        <div class="w3-panel">
          <div class="content-border content-padding">
            <div class="w3-center">
              <h5><u><b>Deli Brew Goodness and Goodies</b></u></h5>
            </div>

            <p>There are a lot of goodies here at Deli Brew that would satisfy your cravings. So select a menu from Deli Brew.</p>
          </div>
          <div class="container">
            <div class="grid">
              <div class="cell content-coffee">
                <a href="coffee.php">
                  <img src="http://sawadacoffee.com/wp-content/uploads/Sawada-Coffee-10DEC2015-003.jpg" class="responsive-image" alt="coffee" style="width:100%">
                  <div class="caption product-content">
                    <div class="w3-center">
                      <span class="category">Coffee</span>
                      <span class="button"><button id="learn-more" class="learn-more-btn">Learn More</button></span>
                    </div>
                  </div>
                </a>
              </div>
              <div class="cell snacks">
                <a href="snacks.php">
                  <img src="https://www.southcatering.co.uk/images/photos/product/large/muffins-and-cookies-platter.jpg" class="responsive-image" alt="snack" style="width:100%">
                  <div class="caption product-content">
                    <div class="w3-center">
              ...
              <div class="cell content-pastry">
                <a href="pastry.php">
                  <img src="https://danielchocolates.com/wp-content/uploads/2016/05/pastries.jpg" class="responsive-image" alt="pastry" style="width:100%">
                  <div class="caption product-content">
                    <div class="w3-center">
