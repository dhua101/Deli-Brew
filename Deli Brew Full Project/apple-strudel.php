    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://cookdiary.net/wp-content/uploads/images/Apple-Strudel.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Apple Strudel</p>
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM applestrudel_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="applestrudelreview.php" method="GET">
                Name<br>
