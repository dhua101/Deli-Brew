    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <div class="w3-center">
            <h3>Original Blend Coffee</h3>
          </div>
        </div>

        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="https://gj-aus-prod.s3.amazonaws.com/production/spark/product_pictures/10/large/Coffee_-_Blends_-_Special_Espresso.jpg?1357747274" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Original Blend</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='1'";
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM original_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="originalreview.php" method="GET">
                Name<br>
