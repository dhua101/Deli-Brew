    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://newyork.seriouseats.com/20110203TedandHoneymuffins/Muffinzz%20Serious%20Eats.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Muffin</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='7'";
              ...
              ?>
              Quantiity:
              <select id ="quantity7" name="quantity7">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM muffin_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="muffinreview.php" method="GET">
                Name<br>
