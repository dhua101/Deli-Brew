    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          ...
          <div class="w3-panel">
            <h3>What's New?</h3>
            <p>Browse through our news releases here to see what's new at Deli Brew.</p>
            <a href="newsroom.php">Learn More</a>
          </div>

          <div class="w3-panel">
            <h3>Multimedia</h3>
            <p>Watch videos, look at galleries, and more.</p>
            <a href="multimedia.php">Learn More</a>
          </div>
        </div>
      </div>
    </div>
