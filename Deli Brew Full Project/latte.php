    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="https://image.shutterstock.com/z/stock-photo-coffee-beans-and-a-cup-of-coffee-with-beautiful-latte-art-260919488.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Latte</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='3'";
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM latte_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="lattereview.php" method="GET">
                Name<br>
