    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <div class="w3-center">
            <h2>Perks when Working at Deli Brew</h2>
          </div>
        </div>
      </div>
      ...
      <div class="w3-panel">
        <h3>Perks</h3>
        <p>There are perks when working at Deli Brew.</p>
        <ul>
          <li>Work-Play Balance</li>
          <li>Relaxing beverages for you to enjoy</li>
          <li>Positive Vibes and Positive Attitude</li>
          <li>Positive Work Environment</li>
          <li>Friend Seeking</li>
          <li>Good interaction with Customers</li>
          <li>Friendly with guests</li>
          <li>Special Events</li>
          <li>Road Trips and Field Trips</li>
        </ul>
      </div>
    </div>
  </div>
