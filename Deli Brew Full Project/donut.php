    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://www.mapledonuts.com/uploads/donut%20platter.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Donut</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='9'";
              ...
              ?>
              Quantiity:
              <select id ="quantity9" name="quantity9">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM donut_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="donutreview.php" method="GET">
                Name<br>
