...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC3VU-WkzraEnUed_ElnT7Ma4lfizm65MU&callback=myMap"></script>
  <!--[if lt IE 9]>
    <script src="http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js"></script>
  <![endif]-->
</head>
<body class="max-size" onload="myMap()">
  <!-- Side Navigation -->
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active w3-white"><a href="#">Find the Cafe</a></li>
