    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://2.bp.blogspot.com/-z0qDwGGxAdQ/UYs3QKHCWiI/AAAAAAAAev4/4WMnlJjzY5A/s1600/photo+5.JPG" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Donut Bites</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='11'";
              ...
              ?>
              Quantiity:
              <select id ="quantity11" name="quantity11">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM donutbite_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="donutbitereview.php" method="GET">
                Name<br>
