    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <div class="w3-center">
            <h2>Deli Brew Purpose</h2>
          </div>

          <h4>Restaurant Team Member</h4>
          <p>Passion and drive to make someone's day better when working everyday.</p>

          <h4>Trainer</h4>
          <p>Train, coach, and build a strong team of workers. Supporting the team members is important for success. With the skills and knowledge staff needs to succeed, you succeed as well.</p>

          <h4>Team Supervisor</h4>
          <p>Leaders that lead the team by example. Guests and customers are the ones that are their highest priority. Share ideas and look for opportunities to empower your team in making the right decisions.</p>

          <h4>Assistant Restaurant Manager</h4>
          <p>With enthusiasm and passion, train and guide your team to high standards in terms of service and quality for Deli Brew.</p>

          <h4>Restaurant Manager</h4>
          <p>The vision and the expertise are the tools you need to build a successful business. Recruit, build, and leader your team. Promote with open communication, respect for others, and strong culture and work ethic.</p>
        </div>
      </div>
    </div>
  </div>
