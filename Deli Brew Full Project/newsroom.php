    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          <div class="w3-center">
            <h2>What's New?</h2>
            <p>Get all the latest news on what's going on in Deli Brew here.</p>
          </div>
        </div>
      </div>

      <div class="col-xs-2">
        <div class="w3-panel side-pill">
          <ul class="nav nav-pills nav-stacked">
            <li class="active"><a data-toggle="pill" href="#home">Main Menu</a></li>
            <li><a data-toggle="pill" href="#news2017">2017</a></li>
          </ul>
        </div>
      </div>
      <div class="col-xs-10">
        <div class="w3-panel">
          <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
              Look through the years to see the news on what's happening in Deli Brew.
            </div>
            <div id="news2017" class="tab-pane fade">
              <div class="container">
                <div class="grid">
                  <div class="cell cell-padding cell-color">
                    <p>Deli Brew website has unofficially make it's mark and ready for opening.</p>
                    <p>16/03/2017</p>
                  </div>
                </div>
              </div>
