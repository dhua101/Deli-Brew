    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://www.bakepedia.com/wp-content/uploads/2013/08/eclair-inside-of-eclair.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Eclair</p>
            <form method="get" action="cart.php">
              Price: $5.49<br>
              Quantiity:
              <select id ="quantity14" name="quantity14">
        ...
        <div class="w3-panel">
            ...
            <form action="eclairreview.php" method="GET">
                Name<br>
