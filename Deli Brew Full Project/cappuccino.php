    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://beanboyscoffee.com/coffeeBean300.png" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Cappuccino</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='4'";
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM cappuccino_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="cappuccinoreview.php" method="GET">
                Name<br>
