    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://comendocomosolhos.com/wp-content/uploads/2015/04/macaron.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Macaron</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='15'";
              ...
              ?>
              Quantiity:
              <select id ="quantity15" name="quantity15">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM macaron_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="macaronreview.php" method="GET">
                Name<br>
