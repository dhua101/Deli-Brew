    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://vignette1.wikia.nocookie.net/cookieclicker/images/b/b9/Chocolate_Chip_Cookies_-_kimberlykv.jpg/revision/latest/scale-to-width-down/258?cb=2013092521325" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Cookie</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='8'";
              ...
              ?>
              Quantiity:
              <select id ="quantity8" name="quantity8">
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM cookie_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="cookiereview.php" method="GET">
                Name<br>
