    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="w3-panel content-border">
          <div class="col-xs-5">
            <img src="http://thesmickle.com/wp-content/uploads/2011/12/espresso-beans.jpg" class="responsive-image" alt="original" style="width:100%">
          </div>
          <div class="col-xs-7">
            <p>Espresso</p>
            <form method="get" action="cart.php">
              ...
              <?php
                  ...
                  $sqlstock = "SELECT product_quantity FROM products_tbl WHERE product_id='5'";
        ...
        <div class="w3-panel">
          ...
          <?php
              ...
              $sql = "SELECT * FROM espresso_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="espressoreview.php" method="GET">
                Name<br>
