    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="w3-panel top-margin-content">
          ...
          <h4>Why Join Deli Brew?</h4>
          <p>At Deli Brew, the most valuable and important aspect is to make the work environment more fun and enjoyable. The work environment that is provided for the Deli Brew staffs bring the team together as a bond. We want to give opportunities to make someone's day that much better, if not, the best, everyday.</p>
          <p>We look for in applicants are many qualities:</p>
          <ul>
            <li>positive attitude</li>
            <li>confidence</li>
            <li>team player</li>
            <li>passion for working</li>
            <li>enjoyment and great time with other staff members</li>
          </ul>
        </div>
      </div>

      <div class="col-xs-4">
        <h3>Deli Brew Exprience</h3>
        <p><a href="career-perks.php">Learn more</a> about the advantages and perks of working with Deli Brew.</p>
      </div>
      <div class="col-xs-4">
        <h3>What Makes it a Success</h3>
        <p><a href="career-purpose.php">Hear what makes Deli Brew a successful Cafe.</a></p>
      </div>
      <div class="col-xs-4">
        <h3>Join the Team</h3>
        <p>Apply for Employment using the Application <a href="career-application.php">here</a></p>
      </div>
    </div>
  </div>
      ...
      <div class="grid">
        <div class="bottom-cell">
          <div class="w3-center">
            ...
            <h3>Career Centre</h3>
            <p>Ready to join the team? Learn More <a href="#">here</a></p>
